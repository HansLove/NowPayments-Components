...
<div className="sb-container">
  ...
  <div className="sb-section">
    <div className="sb-section-item">
      ...
      <p className="sb-section-item-paragraph">
        • Display available currencies from NOWPayments<br/>
        • Collect and validate form data<br/>
        • Handle UI states (loading, error, success)<br/>
        • Provide theming and customization
      </p>
    </div>
    ...
    <div className="sb-section-item">
      ...
      <p className="sb-section-item-paragraph">
        • Process payments with NOWPayments API<br/>
        • Handle webhooks and IPN callbacks<br/>
        • Manage business logic<br/>
    ...
    <div className="sb-section-item">
      ...
      <p className="sb-section-item-paragraph">
        ...
        2. User fills form → Fixed schema<br/>
        3. onSubmit() → Your backend<br/>
        4. Backend processes → Custom response<br/>
        5. onSuccess() → Handle any schema
      </p>
    </div>
...
- **Theming/Caos Engines Demo** - Cyberpunk theme showcase
- **CSS Customization** - Theming examples and documentation

Each story includes interactive controls to test different states and configurations.

## 🎨 Theme Showcase

This Storybook includes a special **Caos Engines inspired theme** that demonstrates the powerful theming capabilities of the component library. The cyberpunk-styled theme features:

- **Dark navy backgrounds** with gradient effects
- **Electric red primary colors** with neon glows
- **Cyan blue accents** for highlights and interactions
- **Smooth animations** and hover effects
- **Modern cyberpunk aesthetic** perfect for gaming and fintech apps

Visit the [Theming/Caos Engines Demo](?path=/story/theming-caos-engines-demo--overview) to see the complete themed experience!
